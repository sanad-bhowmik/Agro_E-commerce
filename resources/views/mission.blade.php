    ...
    <section class="mission-goals py-12 bg-gray-100 mt-10">
        <div class="container mx-auto px-6 lg:px-8 text-center lg:text-left">
            <div class="lg:w-3/4 mx-auto">
                <h2 class="text-3xl lg:text-4xl font-bold text-green-700 mb-6 text-center">Our Commitment to Sustainable
                    Agriculture</h2>
                <p class="text-lg lg:text-xl text-gray-700 mb-8 text-center">
                    At [Your Company Name], we’re deeply committed to preserving the health of our planet through
                    sustainable farming. We believe that innovation, responsibility, and collaboration are key to
                    creating a resilient agricultural future.
                </p>
            </div>
            ...
            <div class="h-full w-full pt-12 p-4" style="display: flex;gap: 26px; justify-content: space-between;">
                ...
                @if($mission)
                    <div
                        class="w-full md:w-1/3 h-80 rounded-xl bg-white p-6 text-center shadow-xl flex flex-col justify-between">
                        <div
                            class="mx-auto flex h-16 w-16 -translate-y-12 transform items-center justify-center rounded-full bg-green-400 shadow-lg shadow-green-500/40">
                ...
                @if($mission)
                    <div
                        class="w-full md:w-1/3 h-80 rounded-xl bg-white p-6 text-center shadow-xl flex flex-col justify-between">
                        <div
                            class="mx-auto flex h-16 w-16 -translate-y-12 transform items-center justify-center rounded-full bg-purple-400 shadow-lg shadow-red-500/40">
                ...
                @if($mission)
                    <div
                        class="w-full md:w-1/3 h-80 rounded-xl bg-white p-6 text-center shadow-xl flex flex-col justify-between">
                        <div
                            class="mx-auto flex h-16 w-16 -translate-y-12 transform items-center justify-center rounded-full bg-red-400 shadow-lg shadow-green-500/40">
