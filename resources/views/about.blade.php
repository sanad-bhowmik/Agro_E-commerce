...
<body>
    ...
    <nav class="relative px-4 py-4 flex justify-between items-center bg-white " style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
        ...
        <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
            <li><a class="text-sm text-gray-400 font-bold hover:text-gray-500" href="/">Home</a></li>
            <li class="text-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
                </svg>
            </li>
            <li><a class="text-sm text-blue-600 font-bold hover:text-gray-500" href="/about">About Us</a></li>
            <li class="text-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
                </svg>
        ...
        <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
            ...
            <div>
                <ul>
                    ...
                    <li class="mb-1">
                        <a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="/product">Products</a>
                    </li>
                    <li class="mb-1">
    ...
    <section class="max-w-5xl mx-auto p-6 mt-10 bg-white">
        <!-- Title Section -->
        <div class="mb-4 border-b-2 border-orange-600 pb-2">
            <h2 class="text-2xl font-bold text-gray-800">Introduction</h2>
        </div>

        <!-- Image Section -->
        <div class="mb-6">
            <img src="https://img.freepik.com/premium-photo/golden-wheat-field-bordering-lush-green-pasture-showcasing-contrast-agriculture-n_483949-29024.jpg?size=626&ext=jpg&ga=GA1.1.2008272138.1727740800&semt=ais_hybrid" alt="Wheat Field" class="w-full h-auto rounded-md">
        </div>

        <!-- Text Section -->
        <div class="text-justify text-gray-700 leading-relaxed">
            <p>
                Our organization has been working towards supporting the various activities of agricultural production in the country. Since 2003, we have been providing the highest quality services to farmers. Our main objective is to increase production and supply high-quality products to farmers.
            </p>
            <p class="mt-4">
                Our efforts include working with farmers to prevent crop diseases and manage pests. Our team works tirelessly and always stands by the farmers. Through the use of technology and innovation, we strive to introduce improved and efficient farming methods.
            </p>
            <p class="mt-4">
                We are proud that our success is backed by the relentless efforts and support of all employees, stockists, retailers, and farmer brothers. Our goal is to continuously work to increase agricultural production and improve the income of farmers in the country.
            </p>
        </div>
    </section>
