...
<body>
    ...
    <section style="background-color: #f6f6f6;">
        <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20" style="margin-top: 15%;">
            <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-5">
                <div class="text-center">
                    ...
                    <h6 class="text-4xl font-bold text-deep-purple-accent-400" style="color: #2f2766;font-size: 38px;font-family: math;">4</h6>
                ...
                <div class="text-center">
                    ...
                    <h6 class="text-4xl font-bold text-deep-purple-accent-400" style="color: #2f2766;font-size: 38px;font-family: math;">230+</h6>
                    <p style="color: #585757;font-size: 18px;font-weight: 700;font-family: math;">
                        Agro Input Products
                    </p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h6 class="text-4xl font-bold text-deep-purple-accent-400" style="color: #2f2766;font-size: 38px;font-family: math;">21+</h6>
                    <p style="color: #585757;font-size: 18px;font-weight: 700;font-family: math;">
                        Branch offices
                    </p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h6 class="text-4xl font-bold text-deep-purple-accent-400" style="color: #2f2766;font-size: 38px;font-family: math;">4500+</h6>
                    <p style="color: #585757;font-size: 18px;font-weight: 700;font-family: math;">
    ...
    <footer class="text-gray-400 bg-black body-font">
        <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <p class="text-sm text-gray-400 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-800 sm:py-2 sm:mt-0 mt-4">© 2024 Eventas —
                <a href="https://playon24.com.bd/" class="text-gray-500 ml-1" target="_blank" rel="noopener noreferrer">PlayOn24</a>
            </p>
