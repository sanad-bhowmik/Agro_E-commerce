...
<body>
    ...
    <section class="text-gray-700 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap card">
                <img alt="{{ $product->name }}" class="lg:w-1/2 w-full object-cover object-center rounded-l-lg product-image"
                    src="{{ asset('img/product/' . $product->image) }}">
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 p-6">
                    <h2 class="text-sm title-font text-gray-600 tracking-widest uppercase">{{ $product->brand }}</h2>
                    <h1 class="text-gray-900 text-4xl title-font font-bold mb-2">{{ $product->name }}</h1>
                    <div class="flex mb-4">
                        <span class="title-font font-medium text-3xl text-gray-900">{{ $product->price }} BDT</span>
                    </div>
                    <p class="leading-relaxed mb-4 text-gray-700">{{ $product->details }}</p>
                </div>
            </div>
        </div>
    </section>
