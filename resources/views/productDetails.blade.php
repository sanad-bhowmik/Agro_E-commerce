...
<body>
    ...
    <nav class="relative px-4 py-4 flex justify-between items-center bg-white " style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
        ...
        <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
            ...
            <li><a class="text-sm text-blue-600 font-bold hover:text-gray-500" href="/product">Product</a></li>
            <li class="text-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
                </svg>
    ...
    <div style='background-color:rgba(255, 255, 255, 1)'>
        <div class="container px-5 py-24 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap bg-white shadow-xl rounded-lg overflow-hidden" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
                <!-- Product Image Section -->
                <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded transition-transform duration-300 transform hover:scale-105 cursor-pointer"
                    src="{{ asset('img/product/' . $product->image) }}" style="width: 220px;" id="productImage">
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 p-6 flex flex-col justify-between">
                    <div>
                        <h2 class="text-sm title-font text-gray-500 tracking-widest">BRAND: {{ $product->brand }}</h2>
                        <h1 class="text-gray-900 text-3xl title-font font-semibold mb-1">{{ $product->name }}</h1>
                        <div class="flex mb-4">
                            ...
                            <span class="flex ml-3 pl-3 py-2 border-l-2 border-gray-200 space-x-2">
                                <span class="title-font font-medium text-2xl text-gray-900">{{ $product->price }} BDT</span>
                            </span>
                        </div>
                        <p class="leading-relaxed text-gray-600">{{ $product->details }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="imageModal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.8); z-index: 1000; justify-content: center; align-items: center;">
        <span class="close" style="color: #fff; font-size: 40px; font-weight: bold; position: absolute; top: 20px; right: 30px; cursor: pointer; transition: 0.3s;">&times;</span>
        <img id="modalImage" src="" alt="Product Image" style="max-width: 90%; max-height: 90%; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);">
    </div>
