...
<body>
    ...
    <div class="min-h-screen pb-28 sm:pb-0">
        <div class="lg:h-[767px] bg-gray-900">
            <div class="max-w-7xl min-h-screen mx-auto p-4 sm:p-10 lg:py-20">
                <div class="max-w-5xl mx-auto text-center text-white tracking-widest pb-10 lg:pb-20">
                    ...
                    <h1 class="text-3xl sm:text-5xl font-black">The right price for you, whoeveryou are</h1>
                    <p class="text-xl sm:text-2xl font-light text-gray-200 px-10 py-6">Lorem ipsum has been the industry's standard dummy text ever since , when an unknown printer took a galley of type and scrambled.</p>
                </div>
                ...
                <div class="flex flex-col lg:flex-row justify-center items-center  gap-8 lg:gap-0 lg:mt-4">
                    <div class="flex-1 w-full mb-6 bg-white rounded-xl shadow-xl lg:scale-95">
                        <div class="text-center p-12">
                            ...
                            <div class="flex justify justify-center items-center">
                                <span class="font-extrabold text-5xl lg:text-4xl xl:text-6xl align-text-middle px-3">$ 79</span>
                    ...
                    <div class="lg:max-w-max mb-6 relative w-full bg-white rounded-xl shadow-xl border-2 border-indigo-600 lg:scale-110 z-10">
                        <div class="text-center p-12">
                            <p class="text-3xl lg:text-2xl xl:text-3xl pb-4 font-semibold">Growth</p>
                            <div class="flex justify justify-center items-center">
                                <span class="font-extrabold text-5xl lg:text-4xl xl:text-6xl align-text-middle px-3">$ 149</span>
                                <span class="font-normal text-xl text-gray-500 inline-block align-text-middle">/month</span>
                            </div>
                        </div>
                        <div class="bg-gray-100 rounded-b-xl border-t-2 border-gray-200/20 p-10">
                    ...
                    <div class="flex-1 w-full mb-6 bg-white rounded-xl shadow-xl lg:scale-95">
                        <div class="text-center p-12">
                            <p class="text-3xl lg:text-2xl xl:text-3xl pb-4">Hobby</p>
                            <div class="flex justify justify-center items-center">
                                <span class="font-extrabold text-5xl lg:text-4xl xl:text-6xl align-text-middle px-3">$ 349</span>
                                <span class="font-normal text-xl text-gray-500 inline-block align-text-middle">/month</span>
                            </div>
                        </div>
                        <div class="bg-gray-100 rounded-b-xl border-t-2 border-gray-200/20 p-10">
