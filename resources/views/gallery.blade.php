...
<body>
    ...
    <nav class="sticky top-0 z-50 relative px-4 py-4 flex justify-between items-center bg-white " style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
        ...
        <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
            ...
            <li><a class="text-sm text-blue-600 font-bold hover:text-gray-500" href="/gallery">Gallery</a></li>
            <li class="text-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
                </svg>
    ...
    <section class="relative h-96 md:h-[500px] lg:h-[600px] mt-2 w-full flex items-center justify-start bg-black text-white overflow-hidden" style="display: none;">
        <!-- Video Container -->
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mt-6 mb-6">
        ...
        <div>
            <!-- Display each image from the database with full size and maintaining aspect ratio -->
            <img class="h-48 w-full object-contain rounded-lg cursor-pointer"
                src="{{ asset('img/gallery/' . $image->img) }}"
                alt="Image"
                data-image="{{ asset('img/gallery/' . $image->img) }}"
    ...
    <div id="imageModal" class="fixed inset-0 bg-gray-700 bg-opacity-75 hidden justify-center items-center z-50" onclick="closeModal()">
