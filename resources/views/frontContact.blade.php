                ...
                <ul class="flex flex-col space-y-2">
                    ...
                    <li class="text-sm text-gray-500 ">
                        <a href="/frontContact"
                            ...
                            <div class="pr-2">
                                <svg fill="#B1B7C0" version="1.1" id="Layer_1" class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 337.559 337.559" xml:space="preserve" width="64px" height="64px">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                    <g id="SVGRepo_iconCarrier">
                                        <g>
            ...
            <main class="bg-[#f3f3f9] mb-auto flex-grow">
                ...
                <div class="bg-gray-100 min-h-screen flex justify-center items-center p-6">
                    <div class="bg-white p-8 rounded-lg shadow-md" style="width: 98%;margin-top: -9%;">
                        <!-- Contact Form -->
                        <form action="{{ route('updateContact') }}" id="contactForm" method="POST" enctype="multipart/form-data">
                            @csrf

                            <!-- Name and Email -->
                            <div class="mb-8">
                                <!-- Email Input -->
                                <div class="shadow-lg flex items-center bg-white p-4 border border-gray-300 rounded-lg hover:shadow-xl transition duration-300 mb-6">
                                    <input type="email" name="email" class="flex-1 pl-3 py-3 text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400 rounded-md font-medium" placeholder="Enter Your Email" value="{{ old('email', $contact->email ?? '') }}" required />
                                </div>
                            </div>
                            ...
                            <div class="mb-8">
                                <!-- Phone Number Input -->
                                <div class="shadow-lg flex items-center bg-white p-4 border border-gray-300 rounded-lg hover:shadow-xl transition duration-300 mb-6">
                                    <input type="tel" name="number" class="flex-1 pl-3 py-3 text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400 rounded-md font-medium" placeholder="Enter Your Phone Number" value="{{ old('number', $contact->number ?? '') }}" required />
                                </div>

                                <!-- Address Input -->
                                <div class="shadow-lg flex items-center bg-white p-4 border border-gray-300 rounded-lg hover:shadow-xl transition duration-300 mb-6">
                                    <input type="text" name="address" class="flex-1 pl-3 py-3 text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400 rounded-md font-medium" placeholder="Enter Your Address" value="{{ old('address', $contact->address ?? '') }}" required />
                                </div>
                            </div>
