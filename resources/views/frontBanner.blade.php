                ...
                <div class="bg-gray-100 min-h-screen flex justify-center items-center p-6">
                    <div class="bg-white p-8 rounded-lg shadow-md" style="width: 98%;margin-top: -17%;">
                        ...
                        <div class="flex border-b border-gray-300 mb-6">
                            <button class="tab-button active-tab px-4 py-2 text-blue-600 border-b-2 border-blue-600 focus:outline-none transition-all duration-300 ease-in-out transform hover:scale-105 hover:text-white hover:bg-blue-600" onclick="showTab('bannerTab', this)">
                                Banner Form
                            </button>
                            <button class="tab-button px-4 py-2 text-gray-600 focus:outline-none transition-all duration-300 ease-in-out transform hover:scale-105 hover:text-white hover:bg-blue-600" onclick="showTab('demoTab', this)">
                                About US
                            </button>
                        </div>
                        ...
                        <div id="bannerTab" class="tab-content">
                            <form action="{{ route('banner.store') }}" id="bannerForm" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <!-- Banner Title -->
                                    <div class="mb-8 shadow-md flex items-center bg-white p-3 border border-gray-300 rounded-md hover:shadow-lg transition duration-200">
                                        <input type="text" name="title" class="flex-1 pl-2 text-gray-700 placeholder-gray-400 focus:outline-none" placeholder="Banner Title" required />
                                    </div>

                                    <!-- First Video -->
                                    <div class="shadow-md flex items-center bg-white p-3 border border-gray-300 rounded-md hover:shadow-lg transition duration-200" style="height: 52px;">
                                        <input type="file" name="firstVideo" class="flex-1 pl-2 text-gray-700 placeholder-gray-400 focus:outline-none" accept="video/*" required />
                                    </div>
                                    ...
                                    <div class="shadow-md flex items-center bg-white p-3 border border-gray-300 rounded-md hover:shadow-lg transition duration-200">
                                        <input type="file" name="secondVideo" class="flex-1 pl-2 text-gray-700 placeholder-gray-400 focus:outline-none" accept="video/*" required />
                                    </div>

                                    <!-- Third Video -->
                                    <div class="shadow-md flex items-center bg-white p-3 border border-gray-300 rounded-md hover:shadow-lg transition duration-200">
                                        <input type="file" name="thirdVideo" class="flex-1 pl-2 text-gray-700 placeholder-gray-400 focus:outline-none" accept="video/*" required />
                                    </div>
                                </div>

                                <!-- Submit Button -->
                                <div class="flex justify-center mt-8">
                                    <button type="submit" class="py-2.5 px-6 text-sm bg-indigo-500 text-white rounded-full cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 hover:bg-indigo-700">Save</button>
                                </div>
                            </form>
                        </div>

                        <div id="demoTab" class="tab-content hidden">
                            <form action="{{ route('frontAbout.save') }}" id="demoForm" method="POST" enctype="multipart/form-data">
                                @csrf

                                <!-- Description Input -->
                                <div class="mb-8 shadow-md flex items-center bg-white p-3 border border-gray-300 rounded-md hover:shadow-lg transition duration-200">
                                    <textarea name="description" class="flex-1 pl-2 text-gray-700 placeholder-gray-400 focus:outline-none" placeholder="Enter Description" required></textarea>
                                </div>

                                <!-- Video Upload Input -->
                                <div class="shadow-md flex items-center bg-white p-3 border border-gray-300 rounded-md hover:shadow-lg transition duration-200 mb-6">
                                    <input type="file" name="video" class="flex-1 pl-2 text-gray-700 placeholder-gray-400 focus:outline-none" accept="video/*" required />
                                </div>
