            ...
            <main class="bg-[#f3f3f9] mb-auto flex-grow">
                ...
                <div class="bg-gray-100 min-h-screen flex justify-center items-center p-6">
                    <div class="bg-white p-8 rounded-lg shadow-md" style="width: 98%;">
                        <!-- Product Upload Form -->
                        <form action="{{ route('mission.store') }}" id="missionForm" method="POST" enctype="multipart/form-data">
                            @csrf

                            <!-- Product Name and Image -->
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                <!-- Hero Title Input -->
                                <div class="shadow-lg flex items-center bg-white p-4 border border-gray-300 rounded-lg hover:shadow-xl transition duration-300">
                                    <svg fill="#000000" xmlns="http://www.w3.org/2000/svg" height="1.25rem" width="1.25rem" viewBox="0 0 512 512">
                                        <!-- SVG Path -->
                                    </svg>
                                    <input type="text" name="name" class="flex-1 pl-3 py-3 text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400 rounded-md font-medium" placeholder="Enter the Product Title" required />
                                </div>
                                ...
                                <div class="shadow-lg flex items-center bg-white p-4 border border-gray-300 rounded-lg hover:shadow-xl transition duration-300">
                                    ...
                                    <input type="file" name="image" class="flex-1 pl-3 py-3 text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400 rounded-md font-medium" required />
                                </div>
                            </div>

                            <!-- Product Details -->
                            <div class="mb-6 shadow-lg bg-white p-4 border border-gray-300 rounded-lg hover:shadow-xl transition duration-300">
                                <textarea name="details" rows="5" class="w-full text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400 rounded-md font-medium" placeholder="Provide detailed description of the product" required></textarea>
                            </div>
                            ...
                            <div class="space-y-6">
                                @for($i = 1; $i <= 3; $i++)
                                    ...
                                    <div class="flex gap-4 mt-4">
                                        <input type="text" name="cardOnetitle{{ $i }}" class="w-1/2 p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 font-medium" placeholder="Enter Card {{ $i }} Title" required />
                                        <textarea name="cardOnedescription{{ $i }}" rows="3" class="w-1/2 p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 font-medium" placeholder="Enter Card {{ $i }} Description" required></textarea>
                                    </div>
                            </div>
                            @endfor
                    </div>
                    ...
                    <div class="flex justify-center mt-8">
                        <button type="submit" class="bg-blue-500 text-white px-8 py-3 rounded-lg shadow-md hover:bg-blue-600 transition duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-blue-400">
                            Save
                        </button>
                    </div>
                    </form>
