                ...
                <div class="max-w-5xl mx-auto bg-white p-6 mt-10">
                    <div class="flex flex-col md:flex-row gap-6">
                        ...
                        <div class="zoom-container">
                            <img id="mainImage" src="./img/product11.png" alt="TOPSIN" class="zoom-image">
                        </div>

                        <div class="flex-1">
                            <h1 class="text-2xl text-red-400">TOPSIN</h1>
                        </div>
                    </div>

                    <!-- Small Thumbnails -->
                    <div class="flex mt-4">
                        <img src="./img/product15.png" alt="Thumbnail 1" class="thumbnail" onclick="changeImage(this)">
                        <img src="./img/product16.png" alt="Thumbnail 2" class="thumbnail" onclick="changeImage(this)">
                        <img src="./img/product17.png" alt="Thumbnail 2" class="thumbnail" onclick="changeImage(this)">
                        <img src="./img/product18.png" alt="Thumbnail 2" class="thumbnail" onclick="changeImage(this)">
                    </div>
                </div>
