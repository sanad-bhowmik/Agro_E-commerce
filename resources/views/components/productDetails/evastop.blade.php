                ...
                <div class="max-w-5xl mx-auto bg-white p-6 mt-10">
                    <div class="flex flex-col md:flex-row gap-6">
                        ...
                        <div class="zoom-container">
                            <img id="mainImage" src="./img/product1.png" alt="Radi 20 Drip" class="zoom-image">
                        </div>

                        <div class="flex-1">
                            <h1 class="text-2xl text-red-400">ইভাস্টপ</h1>
                    ...
                    <div class="flex mt-4">
                        <img id="thumbnail" src="./img/product1.png" alt="Radi 20 Drip Thumbnail" class="thumbnail">
                    </div>
                </div>
