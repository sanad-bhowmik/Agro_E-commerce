...
<head>
    ...
    <title>ইভেন্টাস | সেপনিড 10 ডব্লিউডিজি</title>
                ...
                <div class="max-w-5xl mx-auto bg-white p-6 mt-10">
                    <div class="flex flex-col md:flex-row gap-6">
                        ...
                        <div class="zoom-container">
                            <img id="mainImage" src="./img/product10.png" alt="Radi 20 Drip" class="zoom-image">
                        </div>

                        <div class="flex-1">
                            <h1 class="text-2xl text-red-400">সেপনিড 10 ডব্লিউডিজি</h1>
                            <p class="text-gray-500 mt-2"> <span class="text-red-400">⦿</span>ল্যামডা-সাইহ্যালোথ্রিন ১০%</p>
                        </div>
                    </div>

                    <!-- Small Thumbnail Below -->
                    <div class="flex mt-4">
                        <img id="thumbnail" src="./img/product10.png" alt="Radi 20 Drip Thumbnail" class="thumbnail">
                    </div>
                </div>
