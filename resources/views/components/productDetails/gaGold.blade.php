...
<head>
    ...
    <title>ইভেন্টাস | জিএ-গোল্ড</title>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <main class="col-span-3">
                <div class="max-w-5xl mx-auto bg-white p-6 mt-10">
                    <div class="flex flex-col md:flex-row gap-6">
                        ...
                        <div class="zoom-container">
                            <img id="mainImage" src="./img/product4.png" alt="Radi 20 Drip" class="zoom-image">
                        </div>

                        <div class="flex-1">
                            <h1 class="text-2xl text-red-400">জিএ-গোল্ড</h1>
                            <p class="text-gray-500 mt-2"> <span class="text-red-400">⦿</span>জিব্রেলিক এসিড</p>
                        </div>
                    </div>

                    <!-- Small Thumbnail Below -->
                    <div class="flex mt-4">
                        <img id="thumbnail" src="./img/product4.png" alt="Radi 20 Drip Thumbnail" class="thumbnail">
                    </div>
                </div>
                <div class="w-full max-w-3xl bg-white shadow-md rounded-lg p-6">
                    ...
                    <!-- Tab Content -->
                    <div class="mt-4">
                        <div id="tab1" class="tab-content ">জিএ গোল্ড গাছের দ্রুত বৃদ্ধি, ফুল ও ফল ধারণ এবং ফলন বৃদ্ধিতে
                            অতি অল্প মাত্রায় ব্যবহারে অত্যন্ত কার্যকর একটি উদ্ভিদ বৃদ্ধি নিয়ন্ত্রক
                        </div>
                        <div id="tab2" class="tab-content ">জিব্রেলিক এসিড
                        </div>
                        <div id="tab3" class="tab-content">সব ধরনের ফসল
                        </div>
                        <div id="tab4" class="tab-content ">
                            * পাতা ও কান্ডের বৃদ্ধি ঘটায়
                            <br>
                            * বীজের সুপ্তাবস্থা দূর করে অর্থাৎ অংকুররোদগমে সাহায্য করে
                            <br>
                            * ফুল ফুটাতে সাহায্য করে ও ফুল ঝরা বন্ধ করে
                        </div>
                        <div id="tab5" class="tab-content ">
                            ১ গ্রাম জিএ গোল্ড ৩০ লিটার পানিতে মিশিয়ে স্প্রে |
                            করুন।
                        </div>
